...
import { calculateResizedWidths } from "@/richtext/core/extensions/nodes/table/utils/calculateResizedWidths";
...
function handleMouseDown(
  ...
  const finish = (e: MouseEvent) => {
    ...
    try {
      ...
      // Silently catch dispatch errors if editor was unmounted
    }
  };
